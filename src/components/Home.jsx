...
import { addTOpastes, upddateTOpastes,resetTOpastes } from "../redux/pasteSlice";
...
const Home = () => {
 ...
 /*  const {id} = useParams();
  ...
  function createpaste(){
    ...
    if(pasteId){
      // update
    dispatch( upddateTOpastes(paste)) 
    }
    else{
      // create
  ...
  return (
   <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
     ...
     >
      ...
      rounded-lg text-sm px-5 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
